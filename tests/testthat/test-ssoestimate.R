...
test_that("check results of SSO_estimate(k_SSO = 0, n_SSO = 400, N_client = 500, S = 2000)", {
  ...
  expect_silent(y <- SSO_graph_plot(x, visual = FALSE))
  expect_equal(y[["client_max"]], 0.010)
  expect_equal(y[["client_most_prob"]], 0.00025)
  expect_equal(y[["client_min"]], 0.000125)
  expect_equal(y[["SSO_max"]], 0.007)
  expect_equal(y[["SSO_most_prob"]], 0.00025)
  expect_equal(y[["SSO_min"]], 0.000125)
})
