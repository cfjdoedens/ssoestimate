...
We can show the result of the estimation carreid out in teh previous example 
also non visual. The numbers
shown in the non visual presentation are the raw results of the
estimation. The numbers differ slightly from the visual example, as in
the visual example the numbers are not rounded.
